...
HD inline
void choleskyKernel(const T* A, T* C){
...
template<typename T, int N, MatrixIndexOp op = Full>
HD inline
void inverseTriangularKernel(T* A){
...
template<typename T, int N, MatrixIndexOp op = Full>
HD inline
void invertSymmetric(const T* source, T* res){
