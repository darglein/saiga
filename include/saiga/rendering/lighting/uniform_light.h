...
class SAIGA_GLOBAL UniformLightShader : public LightShader{
public:
...
class SAIGA_GLOBAL UniformLight :  public Light
{
...
protected:
    ...
    void bindUniforms(UniformLightShader& shader, Camera* cam);
public:

    UniformLight(){}
    virtual ~UniformLight(){}
