...
static VkResult setupLayers(std::vector<LayerPropertiesEx>& instance_layer_properties)
{
...
VulkanWindow::VulkanWindow()
{
    ...
    {
        VkResult vkres;
        vkres = setupLayers(layerProperties);
        SAIGA_ASSERT(vkres == VK_SUCCESS);
    }
    ...
    int graphics_queue_family_index =  -1;
    {
        ...
        // Create a device object from the physical device
        ...
        cout << "using queue family " << graphics_queue_family_index << endl;
