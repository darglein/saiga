...
//    compute.storageBuffer.allocateMemoryBuffer(renderer.base,vk::MemoryPropertyFlagBits::eHostVisible|vk::MemoryPropertyFlagBits::eHostCoherent);
    compute.storageBuffer.m_memoryLocation.mappedUpload(renderer.base.device, compute.data.data());
    ...
    compute.storageBuffer.m_memoryLocation.mappedDownload(base.device,compute.data.data());
