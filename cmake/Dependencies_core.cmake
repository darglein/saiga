...
if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang" AND SAIGA_CXX_FLAGS_MSVC)
    # with clang-cl don't pass the OpenMP_CXX_FLAGS flags because they point to the clang-style flags
...
if (SAIGA_WITH_SVTAV1)
    set(SAIGA_USE_SVTAV1 1 PARENT_SCOPE)
    
    list(APPEND CORE_INCLUDES "${CMAKE_CURRENT_SOURCE_DIR}/submodules/SVT-AV1/Source/API")
endif ()

if (SAIGA_WITH_LIBAOM)
    set(SAIGA_USE_LIBAOM 1 PARENT_SCOPE)
endif ()
