...
if(SAIGA_DEBUG_ASAN)
    if(SAIGA_CXX_CLANG OR SAIGA_CXX_GNU)
         list(APPEND SAIGA_CXX_FLAGS "-fsanitize=address -fno-omit-frame-pointer -g")
        if(SAIGA_CXX_CLANG)
             list(APPEND SAIGA_CXX_FLAGS "-static-libsan")
        else()
             list(APPEND SAIGA_CXX_FLAGS "-static-libasan")
        endif()
    else()
