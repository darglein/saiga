...
void VertexBuffer<Particle>::setVertexAttributes(){
    ...
    glVertexAttribPointer(3,4, GL_FLOAT, GL_FALSE, sizeof(Particle), (void*) (10 * sizeof(GLfloat)) );
    glVertexAttribIPointer(4,3, GL_INT, sizeof(Particle), (void*) (14 * sizeof(GLfloat)) );
}
