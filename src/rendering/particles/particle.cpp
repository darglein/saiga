...
//    glVertexAttribPointer(2,4, GL_FLOAT, GL_FALSE, sizeof(Particle), (void*) (6 * sizeof(GLfloat)) );
    glVertexAttribPointer(2,2, GL_FLOAT, GL_FALSE, sizeof(Particle), (void*) (6 * sizeof(GLfloat)) );
    glVertexAttribIPointer(3,2, GL_INT, sizeof(Particle), (void*) (8 * sizeof(GLfloat)) );
