...
{
   public:
    static Eigen::Matrix<Scalar, N, 1> num_diff(std::function<Sophus::Vector<Scalar, N>(Scalar)> vector_field,
...
Eigen::Matrix<Scalar, N, M> vectorFieldNumDiff(Fn vector_field, ScalarOrVector const& a,
