...
template <class Scalar_, int Options>
struct traits<Map<Sophus::Sim2<Scalar_>, Options>> : traits<Sophus::Sim2<Scalar_, Options>>
{
    using Scalar          = Scalar_;
...
template <class Scalar_, int Options>
struct traits<Map<Sophus::Sim2<Scalar_> const, Options>> : traits<Sophus::Sim2<Scalar_, Options> const>
{
    using Scalar          = Scalar_;
...
class Sim2Base
{
   public:
    ...
    SOPHUS_FUNC Tangent log() const
    {
        ...
        Matrix2<Scalar> const W_inv       = details::calcWInv<Scalar, 2>(Omega, theta, sigma, scale());
    ...
    SOPHUS_FUNC Transformation matrix() const
    {
        ...
        homogenious_matrix.row(2)                         = Matrix<Scalar, 3, 1>(Scalar(0), Scalar(0), Scalar(1));
    ...
    {
        return Sim2Product<OtherDerived>(rxso2() * other.rxso2(), translation() + rxso2() * other.translation());
    }
    ...
    {
        const PointProduct<HPointDerived> tp = rxso2() * p.template head<2>() + p(2) * translation();
    ...
    ///
    SOPHUS_FUNC void setComplex(Vector2<Scalar> const& z) { rxso2().setComplex(z); }

    /// Accessor of complex number.
    ///
    SOPHUS_FUNC
    typename Eigen::internal::traits<Derived>::RxSO2Type::ComplexType const& complex() const
    {
    ...
    ///
    SOPHUS_FUNC Matrix2<Scalar> rotationMatrix() const { return rxso2().rotationMatrix(); }

    /// Mutator of SO2 group.
    ///
    SOPHUS_FUNC RxSO2Type& rxso2() { return static_cast<Derived*>(this)->rxso2(); }

    /// Accessor of SO2 group.
    ///
    SOPHUS_FUNC RxSO2Type const& rxso2() const { return static_cast<Derived const*>(this)->rxso2(); }
    ...
    ///
    SOPHUS_FUNC void setRotationMatrix(Matrix2<Scalar>& R) { rxso2().setRotationMatrix(R); }
    ...
    ///
    SOPHUS_FUNC void setScaledRotationMatrix(Matrix2<Scalar> const& sR) { rxso2().setScaledRotationMatrix(sR); }
...
class Sim2 : public Sim2Base<Sim2<Scalar_, Options>>
{
   public:
    ...
    ///
    template <class OtherDerived>
    SOPHUS_FUNC Sim2(Sim2Base<OtherDerived> const& other) : rxso2_(other.rxso2()), translation_(other.translation())
    {
    ...
    SOPHUS_FUNC explicit Sim2(Matrix<Scalar, 3, 3> const& T)
        : rxso2_((T.template topLeftCorner<2, 2>()).eval()), translation_(T.template block<2, 1>(0, 2))
    {
    }
    ...
    SOPHUS_FUNC static Transformation hat(Tangent const& a)
    {
        ...
        Omega.template topLeftCorner<2, 2>() = RxSO2<Scalar>::hat(a.template tail<2>());
    ...
    SOPHUS_FUNC static Tangent lieBracket(Tangent const& a, Tangent const& b)
    {
        ...
        Tangent res;
        res[0] = -theta1 * upsilon2[1] + theta2 * upsilon1[1] + sigma1 * upsilon2[0] - sigma2 * upsilon1[0];
        res[1] = theta1 * upsilon2[0] - theta2 * upsilon1[0] + sigma1 * upsilon2[1] - sigma2 * upsilon1[1];
        res[2] = Scalar(0);
        res[3] = Scalar(0);
    ...
    static Sim2 sampleUniform(UniformRandomBitGenerator& generator)
    {
        ...
        return Sim2(RxSO2<Scalar>::sampleUniform(generator), Vector2<Scalar>(uniform(generator), uniform(generator)));
    }
    ...
    SOPHUS_FUNC static Tangent vee(Transformation const& Omega)
    {
        ...
        upsilon_omega_sigma.template tail<2>() = RxSO2<Scalar>::vee(Omega.template topLeftCorner<2, 2>());
...
{
    static_assert(std::is_standard_layout<Sim2>::value, "Assume standard layout for the use of offsetof check below.");
    static_assert(
        offsetof(Sim2, rxso2_) + sizeof(Scalar) * RxSO2<Scalar>::num_parameters == offsetof(Sim2, translation_),
...
template <class Scalar_, int Options>
class Map<Sophus::Sim2<Scalar_>, Options> : public Sophus::Sim2Base<Map<Sophus::Sim2<Scalar_>, Options>>
{
   public:
    ...
    SOPHUS_FUNC Map(Scalar* coeffs) : rxso2_(coeffs), translation_(coeffs + Sophus::RxSO2<Scalar>::num_parameters) {}
    ...
    /// Accessor of RxSO2
    ///
    SOPHUS_FUNC Map<Sophus::RxSO2<Scalar>, Options> const& rxso2() const { return rxso2_; }
...
template <class Scalar_, int Options>
class Map<Sophus::Sim2<Scalar_> const, Options> : public Sophus::Sim2Base<Map<Sophus::Sim2<Scalar_> const, Options>>
{
   public:
    ...
    SOPHUS_FUNC Map(Scalar const* coeffs) : rxso2_(coeffs), translation_(coeffs + Sophus::RxSO2<Scalar>::num_parameters)
    {
    }

    /// Accessor of RxSO2
    ///
    SOPHUS_FUNC Map<Sophus::RxSO2<Scalar> const, Options> const& rxso2() const { return rxso2_; }
