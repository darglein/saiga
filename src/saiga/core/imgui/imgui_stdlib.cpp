...
bool ImGui::Combo(const char* label, int* current_item, const std::vector<std::string>& elements,
                  int popup_max_height_in_items)
{
    ...
    return ImGui::Combo(label, current_item, items.data(), items.size(), popup_max_height_in_items);
}
