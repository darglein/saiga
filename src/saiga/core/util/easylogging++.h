...
#        define ELPP_ASSERT(expr, msg)                                                                             \
            ...
            {                                                                                                      \
                std::stringstream internalInfoStream;                                                              \
                internalInfoStream << msg;                                                                         \
                ELPP_INTERNAL_DEBUGGING_OUT_ERROR << "ASSERTION FAILURE FROM EASYLOGGING++ (LINE: " << __LINE__    \
                                                  << ") [" #expr << "] WITH MESSAGE \""                            \
...
#    if ((ELPP_COMPILER_CLANG && defined(ELPP_CLANG_SUPPORTS_THREAD)) || \
         (!ELPP_COMPILER_CLANG && defined(ELPP_CXX11)) || defined(ELPP_FORCE_USE_STD_THREAD))
   ...
   public:
    ...
    class Parser : base::StaticClass
    {
       ...
       private:
        ...
        static bool parseLine(std::string* line, std::string* currConfigStr, std::string* currLevelStr,
...
class ELPP_EXPORT Writer : base::NoCopy
{
   public:
...
class Helpers : base::StaticClass
{
   public:
    ...
    static void logCrashReason(int sig, bool stackTraceIfAvailable = false, Level level = Level::Fatal,
