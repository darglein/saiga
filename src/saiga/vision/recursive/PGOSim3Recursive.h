...
namespace Saiga
{
class SAIGA_VISION_API PGOSim3Rec : public PGOBase, public LMOptimizer
{
   public:
    using PGOTransformation = DSim3;
    // ============== Recusrive Matrix Types ==============

    static constexpr int pgoBlockSizeCamera = 7;
   ...
   public:
    ...
    PGOSim3Rec() : PGOBase("recursive PGO sim3") {}
    virtual ~PGOSim3Rec() {}
