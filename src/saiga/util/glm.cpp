...
std::string to_string(const mat3 &m){ return helpConvert(transpose(m),16); }
std::string to_string(const mat4 &m){ return helpConvert(transpose(m),16); }
std::string to_string(const vec3 &m){ return helpConvert(m,3); }
std::string to_string(const vec4 &m){ return helpConvert(m,4); }

mat3 mat3FromString(const std::string &str) { return transpose(helpConvertBack<mat3>(str,9)); }
mat4 mat4FromString(const std::string &str) { return transpose(helpConvertBack<mat4>(str,16)); }
vec3 vec3FromString(const std::string &str) { return helpConvertBack<vec3>(str,3); }
vec4 vec4FromString(const std::string &str) { return helpConvertBack<vec4>(str,4); }
