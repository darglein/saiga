...
Function<void, GLenum, GLuint, GLsizei, const GLuint*, const GLintptr*, const GLsizeiptr*> Binding::BindBuffersRange(
    "glBindBuffersRange");
...
Function<void, GLuint, GLuint, GLuint, const GLchar*> Binding::BindFragDataLocationIndexed(
...
Function<void, GLuint, GLuint, GLint, GLboolean, GLint, GLenum, GLint> Binding::BindImageTextureEXT(
...
Function<void, GLuint, GLsizei, const GLuint*, const GLintptr*, const GLsizei*> Binding::BindVertexBuffers(
    "glBindVertexBuffers");
Function<void, GLuint> Binding::BindVertexShaderEXT("glBindVertexShaderEXT");
Function<void, GLuint, GLuint, GLenum, GLintptrARB> Binding::BindVideoCaptureStreamBufferNV(
    "glBindVideoCaptureStreamBufferNV");
Function<void, GLuint, GLuint, GLenum, GLenum, GLuint> Binding::BindVideoCaptureStreamTextureNV(
...
Function<void, GLsizei, GLsizei, GLfixed, GLfixed, GLfixed, GLfixed, const GLubyte*> Binding::BitmapxOES(
    "glBitmapxOES");
...
Function<void, GLuint, GLenum, GLenum, GLenum, GLenum> Binding::BlendFuncSeparateIndexedAMD(
...
Function<void, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, ClearBufferMask, GLenum>
    Binding::BlitFramebuffer("glBlitFramebuffer");
Function<void, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, ClearBufferMask, GLenum>
    Binding::BlitFramebufferEXT("glBlitFramebufferEXT");
Function<void, GLuint, GLuint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, ClearBufferMask, GLenum>
    Binding::BlitNamedFramebuffer("glBlitNamedFramebuffer");
...
Function<void, GLenum, GLintptr, GLsizeiptr, GLeglClientBufferEXT, MapBufferUsageMask>
    Binding::BufferStorageExternalEXT("glBufferStorageExternalEXT");
