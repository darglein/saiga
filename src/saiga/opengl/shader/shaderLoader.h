...
namespace Saiga
{
class SAIGA_GLOBAL ShaderLoader : public Loader<std::shared_ptr<Shader>, ShaderPart::ShaderCodeInjections>,
                                  public Singleton<ShaderLoader>
{
    ...
    std::shared_ptr<shader_t> loadFromFile(const std::string& name, const ShaderPart::ShaderCodeInjections& sci);
   ...
   public:
    ...
    template <typename shader_t>
    std::shared_ptr<shader_t> getLoaded(
        const std::string& name, const ShaderPart::ShaderCodeInjections& sci = ShaderPart::ShaderCodeInjections());
...
template <typename shader_t>
std::shared_ptr<shader_t> ShaderLoader::loadFromFile(const std::string& name,
