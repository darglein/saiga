 ...
 *
 *  @remarks
 *    This registers the glGetError after callback if it wasn't registered before (by an internall call to
 * registerGetErrorCallback()). Thus, any previously registered after callback get overwritten.
 */
