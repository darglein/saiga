...
/**
 *  @brief
 *    Provisioning of meta information about OpenGL extensions, functions and conversion of strings and symbols of the
 * OpenGL API
 */
class GLBINDING_AUX_API Meta
{
   public:
     ...
     *
     *  @remarks
     *    Beware, that some enums in the OpenGL API have different symbol names but identical enum values and that this
     * function cannot differentiate between them
     */
