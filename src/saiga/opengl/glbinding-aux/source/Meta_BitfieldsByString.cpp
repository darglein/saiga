...
const std::unordered_map<std::string, GLbitfield> Meta_BitfieldsByString_A = {
    ...
    {"GL_ATOMIC_COUNTER_BARRIER_BIT_EXT",
     static_cast<GLbitfield>(MemoryBarrierMask::GL_ATOMIC_COUNTER_BARRIER_BIT_EXT)}};
...
const std::unordered_map<std::string, GLbitfield> Meta_BitfieldsByString_C = {
    ...
    {"GL_CLIENT_MAPPED_BUFFER_BARRIER_BIT",
     static_cast<GLbitfield>(MemoryBarrierMask::GL_CLIENT_MAPPED_BUFFER_BARRIER_BIT)},
    {"GL_CLIENT_MAPPED_BUFFER_BARRIER_BIT_EXT",
     static_cast<GLbitfield>(MemoryBarrierMask::GL_CLIENT_MAPPED_BUFFER_BARRIER_BIT_EXT)},
    ...
    {"GL_CONTEXT_COMPATIBILITY_PROFILE_BIT",
     static_cast<GLbitfield>(ContextProfileMask::GL_CONTEXT_COMPATIBILITY_PROFILE_BIT)},
    ...
    {"GL_CONTEXT_FLAG_FORWARD_COMPATIBLE_BIT",
     static_cast<GLbitfield>(ContextFlagMask::GL_CONTEXT_FLAG_FORWARD_COMPATIBLE_BIT)},
    ...
    {"GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT_ARB",
     static_cast<GLbitfield>(ContextFlagMask::GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT_ARB)},
...
const std::unordered_map<std::string, GLbitfield> Meta_BitfieldsByString_G = {
    ...
    {"GL_GLYPH_HORIZONTAL_BEARING_ADVANCE_BIT_NV",
     static_cast<GLbitfield>(PathMetricMask::GL_GLYPH_HORIZONTAL_BEARING_ADVANCE_BIT_NV)},
    {"GL_GLYPH_HORIZONTAL_BEARING_X_BIT_NV",
     static_cast<GLbitfield>(PathMetricMask::GL_GLYPH_HORIZONTAL_BEARING_X_BIT_NV)},
    {"GL_GLYPH_HORIZONTAL_BEARING_Y_BIT_NV",
     static_cast<GLbitfield>(PathMetricMask::GL_GLYPH_HORIZONTAL_BEARING_Y_BIT_NV)},
    {"GL_GLYPH_VERTICAL_BEARING_ADVANCE_BIT_NV",
     static_cast<GLbitfield>(PathMetricMask::GL_GLYPH_VERTICAL_BEARING_ADVANCE_BIT_NV)},
...
const std::unordered_map<std::string, GLbitfield> Meta_BitfieldsByString_M = {
    ...
    {"GL_MAT_AMBIENT_AND_DIFFUSE_BIT_PGI",
     static_cast<GLbitfield>(VertexHintsMaskPGI::GL_MAT_AMBIENT_AND_DIFFUSE_BIT_PGI)},
...
const std::unordered_map<std::string, GLbitfield> Meta_BitfieldsByString_P = {
    {"GL_PERFQUERY_GLOBAL_CONTEXT_INTEL",
     static_cast<GLbitfield>(PerformanceQueryCapsMaskINTEL::GL_PERFQUERY_GLOBAL_CONTEXT_INTEL)},
    {"GL_PERFQUERY_SINGLE_CONTEXT_INTEL",
     static_cast<GLbitfield>(PerformanceQueryCapsMaskINTEL::GL_PERFQUERY_SINGLE_CONTEXT_INTEL)},
...
const std::unordered_map<std::string, GLbitfield> Meta_BitfieldsByString_Q = {
    ...
    {"GL_QUERY_ALL_EVENT_BITS_AMD", static_cast<GLbitfield>(OcclusionQueryEventMaskAMD::GL_QUERY_ALL_EVENT_BITS_AMD)},
    ...
    {"GL_QUERY_DEPTH_BOUNDS_FAIL_EVENT_BIT_AMD",
     static_cast<GLbitfield>(OcclusionQueryEventMaskAMD::GL_QUERY_DEPTH_BOUNDS_FAIL_EVENT_BIT_AMD)},
    {"GL_QUERY_DEPTH_FAIL_EVENT_BIT_AMD",
     static_cast<GLbitfield>(OcclusionQueryEventMaskAMD::GL_QUERY_DEPTH_FAIL_EVENT_BIT_AMD)},
    {"GL_QUERY_DEPTH_PASS_EVENT_BIT_AMD",
     static_cast<GLbitfield>(OcclusionQueryEventMaskAMD::GL_QUERY_DEPTH_PASS_EVENT_BIT_AMD)},
    {"GL_QUERY_STENCIL_FAIL_EVENT_BIT_AMD",
     static_cast<GLbitfield>(OcclusionQueryEventMaskAMD::GL_QUERY_STENCIL_FAIL_EVENT_BIT_AMD)}};
...
const std::unordered_map<std::string, GLbitfield> Meta_BitfieldsByString_S = {
    ...
    {"GL_SHADER_GLOBAL_ACCESS_BARRIER_BIT_NV",
     static_cast<GLbitfield>(MemoryBarrierMask::GL_SHADER_GLOBAL_ACCESS_BARRIER_BIT_NV)},
    {"GL_SHADER_IMAGE_ACCESS_BARRIER_BIT",
     static_cast<GLbitfield>(MemoryBarrierMask::GL_SHADER_IMAGE_ACCESS_BARRIER_BIT)},
    {"GL_SHADER_IMAGE_ACCESS_BARRIER_BIT_EXT",
     static_cast<GLbitfield>(MemoryBarrierMask::GL_SHADER_IMAGE_ACCESS_BARRIER_BIT_EXT)},
...
const std::unordered_map<std::string, GLbitfield> Meta_BitfieldsByString_T = {
    ...
    {"GL_TESS_EVALUATION_SHADER_BIT_EXT",
     static_cast<GLbitfield>(UseProgramStageMask::GL_TESS_EVALUATION_SHADER_BIT_EXT)},
    {"GL_TESS_EVALUATION_SHADER_BIT_OES",
     static_cast<GLbitfield>(UseProgramStageMask::GL_TESS_EVALUATION_SHADER_BIT_OES)},
    ...
    {"GL_TEXTURE_STORAGE_SPARSE_BIT_AMD",
     static_cast<GLbitfield>(TextureStorageMaskAMD::GL_TEXTURE_STORAGE_SPARSE_BIT_AMD)},
    ...
    {"GL_TEXTURE_UPDATE_BARRIER_BIT_EXT",
     static_cast<GLbitfield>(MemoryBarrierMask::GL_TEXTURE_UPDATE_BARRIER_BIT_EXT)},
    {"GL_TRANSFORM_BIT", static_cast<GLbitfield>(AttribMask::GL_TRANSFORM_BIT)},
    {"GL_TRANSFORM_FEEDBACK_BARRIER_BIT",
     static_cast<GLbitfield>(MemoryBarrierMask::GL_TRANSFORM_FEEDBACK_BARRIER_BIT)},
    {"GL_TRANSFORM_FEEDBACK_BARRIER_BIT_EXT",
     static_cast<GLbitfield>(MemoryBarrierMask::GL_TRANSFORM_FEEDBACK_BARRIER_BIT_EXT)}};
...
const std::unordered_map<std::string, GLbitfield> Meta_BitfieldsByString_V = {
    ...
    {"GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT",
     static_cast<GLbitfield>(MemoryBarrierMask::GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT)},
    {"GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT_EXT",
     static_cast<GLbitfield>(MemoryBarrierMask::GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT_EXT)},
...
const std::array<std::unordered_map<std::string, GLbitfield>, 27> Meta_BitfieldsByStringMaps = {
    {Meta_BitfieldsByString_0, Meta_BitfieldsByString_A, Meta_BitfieldsByString_B, Meta_BitfieldsByString_C,
     Meta_BitfieldsByString_D, Meta_BitfieldsByString_E, Meta_BitfieldsByString_F, Meta_BitfieldsByString_G,
     Meta_BitfieldsByString_H, Meta_BitfieldsByString_I, Meta_BitfieldsByString_J, Meta_BitfieldsByString_K,
     Meta_BitfieldsByString_L, Meta_BitfieldsByString_M, Meta_BitfieldsByString_N, Meta_BitfieldsByString_O,
     Meta_BitfieldsByString_P, Meta_BitfieldsByString_Q, Meta_BitfieldsByString_R, Meta_BitfieldsByString_S,
     Meta_BitfieldsByString_T, Meta_BitfieldsByString_U, Meta_BitfieldsByString_V, Meta_BitfieldsByString_W,
     Meta_BitfieldsByString_X, Meta_BitfieldsByString_Y, Meta_BitfieldsByString_Z}};
