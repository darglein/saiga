...
namespace
{
void insertExtension(const std::string& extensionName, std::set<GLextension>* extensions,
...
bool supported(const std::set<glbinding::AbstractFunction*>& functions,
               std::set<glbinding::AbstractFunction*>* unsupported, const bool resolve)
{
    auto support = true;
...
bool supported(const glbinding::Version& version, const bool resolve, std::set<gl::GLextension>* unsupportedExtensions,
...
Version ContextInfo::version()
{
    ...
    const auto version =
        Version(static_cast<unsigned char>(majorVersion & 255), static_cast<unsigned char>(minorVersion & 255));
...
bool ContextInfo::supported(const Version& version, std::set<gl::GLextension>& unsupportedExtensions,
                            std::set<AbstractFunction*>& unsupportedFunctions, const bool resolve)
{
