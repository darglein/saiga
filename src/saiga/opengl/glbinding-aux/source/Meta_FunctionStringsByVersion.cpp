...
const std::map<Version, std::set<std::string>> Meta_FunctionStringsByVersion = {
    ...
    {{1, 3},
     {"glActiveTexture",         "glClientActiveTexture",     "glCompressedTexImage1D",    "glCompressedTexImage2D",
      "glCompressedTexImage3D",  "glCompressedTexSubImage1D", "glCompressedTexSubImage2D", "glCompressedTexSubImage3D",
      "glGetCompressedTexImage", "glLoadTransposeMatrixd",    "glLoadTransposeMatrixf",    "glMultTransposeMatrixd",
      "glMultTransposeMatrixf",  "glMultiTexCoord1d",         "glMultiTexCoord1dv",        "glMultiTexCoord1f",
      ...
      "glMultiTexCoord4sv",      "glSampleCoverage"}},
    {{1, 4},
     {"glBlendColor",
      "glBlendEquation",
      "glBlendFuncSeparate",
      ...
      "glWindowPos3sv"}},
    {{1, 5},
     {"glBeginQuery", "glBindBuffer", "glBufferData", "glBufferSubData", "glDeleteBuffers", "glDeleteQueries",
      "glEndQuery", "glGenBuffers", "glGenQueries", "glGetBufferParameteriv", "glGetBufferPointerv",
      "glGetBufferSubData", "glGetQueryObjectiv", "glGetQueryObjectuiv", "glGetQueryiv", "glIsBuffer", "glIsQuery",
    ...
    {{3, 1},
     {"glBindBufferBase", "glBindBufferRange", "glCopyBufferSubData", "glDrawArraysInstanced",
    ...
    {{4, 6},
     {"glMultiDrawArraysIndirectCount", "glMultiDrawElementsIndirectCount", "glPolygonOffsetClamp",
      "glSpecializeShader"}}};
