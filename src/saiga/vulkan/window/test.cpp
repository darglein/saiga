...
//        cout << "layers " <<  createInfo.enabledLayerCount  << endl;
    ...
    void createSwapChain() {
        ...
        cout << "Swap Chain: graphics family: " << indices.graphicsFamily << " presentfamily: " << indices.presentFamily << endl;
    ...
    VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
        if (capabilities.currentExtent.width != std::numeric_limits<uint32_t>::max()) {
            ...
            cout << "actual extent " << actualExtent.width << "x" << actualExtent.height << endl;
            return actualExtent;
        }
    }
