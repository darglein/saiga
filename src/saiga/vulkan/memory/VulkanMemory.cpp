...
void VulkanMemory::init(vk::PhysicalDevice _pDevice, vk::Device _device)
{
    ...
    bufferAllocators.emplace(vertIndexHostType,
                             std::make_shared<SimpleMemoryAllocator>(m_device, m_pDevice, vertIndexHostType.memoryFlags,
                                                                     vertIndexHostType.usageFlags, true));
    //            std::make_shared<BufferChunkAllocator>(m_device, &chunkAllocator, vertIndexHostType.memoryFlags,
    //                                                vertIndexHostType.usageFlags, strategy,
    //                                                fallback_buffer_chunk_size, true));
