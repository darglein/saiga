...
bool         ImGui_GLFW_Renderer::g_MousePressed[3] = { false, false, false };
float        ImGui_GLFW_Renderer::g_MouseWheel = 0.0f;
GLuint       ImGui_GLFW_Renderer::g_FontTexture = 0;
int          ImGui_GLFW_Renderer::g_ShaderHandle = 0, ImGui_GLFW_Renderer::g_VertHandle = 0, ImGui_GLFW_Renderer::g_FragHandle = 0;
int          ImGui_GLFW_Renderer::g_AttribLocationTex = 0, ImGui_GLFW_Renderer::g_AttribLocationProjMtx = 0;
int          ImGui_GLFW_Renderer::g_AttribLocationPosition = 0, ImGui_GLFW_Renderer::g_AttribLocationUV = 0, ImGui_GLFW_Renderer::g_AttribLocationColor = 0;
unsigned int ImGui_GLFW_Renderer::g_VboHandle = 0, ImGui_GLFW_Renderer::g_VaoHandle = 0, ImGui_GLFW_Renderer::g_ElementsHandle = 0;


// This is the main rendering function that you have to implement and provide to ImGui (via setting up 'RenderDrawListsFn' in the ImGuiIO structure)
// If text or lines are blurry when integrating ImGui in your engine:
// - in your Render function, try translating your projection matrix by (0.5f,0.5f) or (0.375f,0.375f)
void ImGui_GLFW_Renderer::ImGui_ImplGlfwGL3_RenderDrawLists(ImDrawData* draw_data)
{
...
bool ImGui_GLFW_Renderer::ImGui_ImplGlfwGL3_CreateFontsTexture()
{
    // Build texture atlas
    ImGuiIO& io = ImGui::GetIO();
...
bool ImGui_GLFW_Renderer::ImGui_ImplGlfwGL3_CreateDeviceObjects()
{
    // Backup GL state
...
void    ImGui_GLFW_Renderer::ImGui_ImplGlfwGL3_InvalidateDeviceObjects()
{
...
void ImGui_GLFW_Renderer::endFrame()
{
     ImGui::Render();
}
